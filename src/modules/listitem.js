const  listElement=(todo) => { return `<li class="todoList__item" id="${todo.id}"><input class="checkbox" type="checkbox" id=cb-${todo.id} onChange="ToggleCompleted(${todo.id})"  ${todo.isCompleted ?'checked':''}  />
